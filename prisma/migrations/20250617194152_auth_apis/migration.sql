...
-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('VIEW', 'CLICK', 'ADD_TO_CART', 'PURCHASE');
...
-- AddForeignKey
ALTER TABLE "UserActivityLog" ADD CONSTRAINT "UserActivityLog_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
